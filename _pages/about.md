...
*Fun fact*: one of my hobbies is to publishing across various systems-related venues. So far, I have published first-author papers in databases (SIGMOD, VLDB), high-performance computing (SC), computer architecture (ISCA), ML systems (MLSys), and data mining (KDD). OSDI/SOSP is one box I wish I had checked during my PhD --- but it is very much on my agenda as a faculty member! Pro tip: I wouldn't recommend doing this as a new PhD student though, as you will have a hard time to find and settle into a research community.
